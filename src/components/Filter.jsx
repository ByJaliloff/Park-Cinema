...
function Filter() {
  ...
  const isFilterActive = !!selectedLanguage || !!selectedTheatre;
          ...
          <div className="flex gap-6 pb-2 text-[20px]">
            {TABS.map(tab => (
              <button
                ...
                className={`${
                  activeTab === tab ? 'underline underline-offset-4' : 'text-gray-400'
                } transition-all`}
              >
                {tab}
              </button>
        ...
        <div className="flex items-end justify-between gap-4 text-sm mt-2">
          ...
          <div className="flex justify-center gap-4 w-full text-[16px]">
            ...
            >
              ...
              <option disabled className="text-black text-left" style={{ backgroundColor: '#8e8e91' }}>
                Dil
              </option>
              {LANGUAGES.map(lang => (
                <option
